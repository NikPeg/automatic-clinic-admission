...
export const FIELDS: FieldSpec[] = [
  ...
  { key: "insuranceCarrier", label: "Insurance carrier", required: true, askWhen: insured, question: "Who's your insurance carrier? For example, Aetna, Blue Cross Blue Shield, UnitedHealthcare, or Cigna." },
